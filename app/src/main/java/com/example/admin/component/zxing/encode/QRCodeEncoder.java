...
package com.example.admin.component.zxing.encode;
...
import com.example.admin.component.zxing.decode.Contents;
...
//        String url = trim(contact.getURLs());
//        if (url != null) {
//            newContents.append("URL:").append(escapeMECARD(url)).append(';');
//            newDisplayContents.append('\n').append(url);
//        }
        /**适配zxing3.3.0版本的API是getURLs*/
